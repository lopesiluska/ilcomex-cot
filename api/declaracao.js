/**
 * Encaminha declaração de conteúdo (JSON, opcionalmente fotos em base64) ao webhook.
 * DECLARACAO_WEBHOOK_URL na Vercel; senão COTACAO_WEBHOOK_URL; senão o mesmo host padrão da cotação.
 */
...
export default async function handler(req, res) {
  ...
  const webhook = (
    process.env.DECLARACAO_WEBHOOK_URL ||
    process.env.COTACAO_WEBHOOK_URL ||
    DEFAULT_WEBHOOK
  ).trim();
